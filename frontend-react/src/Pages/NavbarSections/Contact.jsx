    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-[#1E3C58] mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-[#1E3C58]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+237 690 00 00</span>
              </div>
              ...
              <div className="flex space-x-4 mt-6">
                <a href="#" className="text-[#1E3C58] hover:text-[#1E3C58]/80">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-[#1E3C58] text-white px-8 py-2 rounded-md hover:bg-[#1E3C58]/90 transition-colors w-full"
              >
                Envoyer
              </button>
            </form>
