    ...
    <div className="p-6 flex-1 bg-[#FFF3E0]">
      ...
      <div className="flex gap-6">
        ...
        <div className="w-2/3 bg-white rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-semibold text-[#8B4513] mb-4">Correlation Matrix</h3>
          ...
          <h3 className="text-lg font-semibold text-[#8B4513] mb-6">Models Comparison and Evaluation</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full text-xs">
              <thead>
                <tr>
                  <th className="px-3 py-1.5 bg-[#8B4513] text-white">Model</th>
                  <th className="px-3 py-1.5 bg-[#8B4513] text-white">MSE</th>
                  <th className="px-3 py-1.5 bg-[#8B4513] text-white">MAE</th>
                  <th className="px-3 py-1.5 bg-[#8B4513] text-white">R²</th>
              ...
              <tbody>
                <tr className="bg-[#FFF3E0]">
                  ...
                  <td className="px-3 py-1.5 text-center">0.198</td>
                  <td className="px-3 py-1.5 text-center">0.312</td>
                  <td className="px-3 py-1.5 text-center">0.878</td>
                  <td className="px-3 py-1.5 text-center">0.45s</td>
                </tr>
                <tr className="bg-white">
                  <td className="px-4 py-2 font-medium text-[#8B4513]">Random Forest</td>
                  <td className="px-4 py-2 text-center">0.187</td>
                  <td className="px-4 py-2 text-center">0.298</td>
                  <td className="px-4 py-2 text-center">0.912</td>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                <select 
                  className="w-full p-1.5 text-xs border rounded-lg text-[#8B4513] cursor-pointer hover:border-[#8B4513]"
                  value=""
                  onChange={(e) => {}}
                >
                ...
                >
                  <option value="" disabled selected={features.variables.length === 0}>Select variables</option>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  onBlur={(e) => {
                    e.currentTarget.size = 1;
                    if (features.variables.length === 0) e.currentTarget.placeholder = "Select variables";
                  }}
                >
                  <option value="" disabled selected={features.variables.length === 0}>Select variables</option>
                  <option value="feature1">☐ Feature 1</option>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  onBlur={(e) => {
                    e.currentTarget.size = 1;
                    if (targets.variables.length === 0) e.currentTarget.placeholder = "Select variables";
                  }}
                >
                  <option value="" disabled selected={targets.variables.length === 0}>Select variables</option>
      ...
      <div className="mt-8">
        <h2 className="text-2xl font-semibold text-[#8B4513] text-center mb-6">
          Prediction Results
        </h2>
